-- create_pos_order now also writes the per-item discount_amount added by
-- 0117_order_item_discount.sql. CREATE OR REPLACE, same signature — only the
-- order_items INSERT column list changes.
